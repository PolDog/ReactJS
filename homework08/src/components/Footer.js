        ...
        <div className="footer_bg">
			<div className="footer_content container">
				...
				<div className="footer_content__right">
					<button className="footer_content__right_fb">
					...
					<button className="footer_content__right_inst">
					...
					<button className="footer_content__right_pin">
					...
					<button className="footer_content__right_twit">
